...
python -m video_forensics.native.decoder_matrix $Video --profile profiles/decoder_matrix/windows_intel_qsv.json --output $Output --ffmpeg $Ffmpeg --ffprobe $Ffprobe
python -m video_forensics.native.decoder_matrix $Video --profile profiles/decoder_matrix/windows_intel_d3d11va.json --output $Output --ffmpeg $Ffmpeg --ffprobe $Ffprobe
